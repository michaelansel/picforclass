...
/**
 * Execute a long running command in a separate thread and display
 * the results in a component while the command is running.
 * 
...
public class ThreadedCommand<T> implements Command<T>
{
    ...
    /**
     * Create a command that runs the given command and updates the
     * given view over time.
     */
